import { Field, SmartContract, state, Permissions, State, method, Struct, UInt64, PublicKey, Bool, Circuit, Provable, TokenContract, AccountUpdate, AccountUpdateForest, Poseidon, VerificationKey, Reducer, Account } from 'o1js';
...
export class PoolList extends SmartContract {
    ...
    async registerTest(_pool: PublicKey, _token0: PublicKey, _token1: PublicKey) {
        ...
        const hashVk = acc1.body.authorizationKind.verificationKeyHash;
        hashVk.assertEquals(poolVerificationKey);
